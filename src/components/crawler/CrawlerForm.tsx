    ...
    reader.onload = (event) => {
      ...
      if (content) {
        ...
        if (validUrls.length > 0) {
          ...
          toast({
            title: "URLs imported",
            description: `Added ${validUrls.length} new URLs${
              invalidUrls.length > 0
                ? `, skipped ${invalidUrls.length} invalid ones`
                : ""
            }`,
            variant: "default",
          });
  ...
  const handleSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: `The crawler has started processing ${
          data.urls.length
        } URL${data.urls.length > 1 ? "s" : ""}`,
        variant: "default",
      });
                    ...
                    {urls.length > 0 ? (
                      ...
                      <div className="flex items-center justify-center p-4 rounded-md border border-dashed">
                        <div className="flex flex-col items-center gap-1.5 text-muted-foreground">
                          ...
                          <p className="text-sm">
                            No URLs added yet. Add URLs to crawl.
                          </p>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="flex items-center text-xs text-muted-foreground">
                      ...
                      {urls.length > 10 && (
                        <span className="text-orange-500">
                          Large number of URLs may take significant time to
                          process
                        </span>
                      )}
                    </div>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 shadow-sm">
                        ...
                        <div className="space-y-1 leading-none">
                          ...
                          <FormDescription className="text-xs">
                            Automatically process with AI and save to product
                            catalog
                          </FormDescription>
                        </div>
                      </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 shadow-sm">
                        ...
                        <div className="space-y-1 leading-none">
                          ...
                          <FormDescription className="text-xs">
                            Specify custom CSS selectors to extract data from
                            specific elements
                          </FormDescription>
                        </div>
                      </FormItem>
                  ...
                  >
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        `Start Crawling (${urls.length} URL${
                          urls.length !== 1 ? "s" : ""
                        })`
                      ) : (
                        "Start Crawling"
