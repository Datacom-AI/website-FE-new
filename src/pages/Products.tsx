...
const mockProducts: Product[] = [
  {
    ...
    image: "/products/organic-granola.webp",
    price: "$4.99",
    pricePerUnit: 4.99,
    rating: 4.5,
  ...
  },
  {
    ...
    image: "/products/premium-coffee-beans.jpg",
    price: "$12.99",
    pricePerUnit: 12.99,
    rating: 4.8,
    productType: "Finished Good",
  ...
  },
  {
    ...
    image: "/products/almond-butter.webp",
    price: "$7.99",
    pricePerUnit: 7.99,
    rating: 4.2,
    productType: "Finished Good",
  ...
  },
  {
    ...
    image: "/products/protein-bars.webp",
    price: "$2.49",
    pricePerUnit: 2.49,
    rating: 4.0,
    productType: "Finished Good",
  ...
  },
  {
    ...
    image: "/products/dried-fruit-mix.jpg",
    price: "$5.49",
    pricePerUnit: 5.49,
    rating: 4.6,
    productType: "Finished Good",
  ...
  useEffect(() => {
    ...
    if (searchParams.get("view") === "favorites") {
      ...
      filteredProducts = filteredProducts.filter((product) => {
        ...
        return (
          price >= priceRange[0] &&
          (priceRange[1] === 100 ? true : price <= priceRange[1])
        );
      });
      ...
      if (selectedLeadTime.length > 0) {
        filteredProducts = filteredProducts.filter((product) =>
          selectedLeadTime.some((time) =>
            product.leadTime.includes(time.split(" ")[0])
          )
        );
      }
      ...
      if (inStockOnly) {
        filteredProducts = filteredProducts.filter(
          (product) => product.minOrderQuantity <= 100
        );
      }
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-foreground/70">
                      {t("lead-time-weeks", {
                        time: product.leadTime,
                        unit: product.leadTimeUnit,
                      })}
                    </span>
                    <span className="text-sm text-foreground/70">
              ...
              >
                ...
                {sustainableOnly && (
                  ...
                  >
                    <Badge
                      variant="secondary"
                      className="flex items-center gap-1 animate-fadeIn bg-green-100 text-green-800 hover:bg-green-200"
                    >
                      {t("sustainable-only")}
                      <motion.button
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <Button
                          ...
                          size="sm"
                          className={`py-1 px-3 h-auto text-xs transition-all duration-200 ${
                            sustainableOnly
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="font-medium">
                          ...
                          {selectedProduct.unitType || t("units")}
                        </p>
                      </motion.div>
                      <motion.div
                        whileHover={{ scale: 1.02 }}
                    ...
                    {selectedProduct.currentAvailable !== undefined && (
                      ...
                      >
                        ...
                        <Progress
                          value={
                            (selectedProduct.currentAvailable /
                              (selectedProduct.minOrderQuantity * 3)) *
                            100
                          }
                          className="h-2 mb-1"
                        />
                        <p className="text-sm">
                          {t("units-available", {
                            quantity: selectedProduct.currentAvailable,
                            unit: selectedProduct.unitType || t("units"),
                          })}
                        </p>
                      </motion.div>
                    )}
